...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'clients/:id/edit', canActivate: [roleGuard], data: { roles: ['Admin','Supervisor'] },
        loadComponent: () => import('./features/clients/form/client-form.component').then(m => m.ClientFormComponent) },
      ...
      { path: 'theme-preview', canActivate: [roleGuard], data: { roles: ['Admin'] },
        loadComponent: () => import('./features/settings/theme-preview.component').then(m => m.ThemePreviewComponent) },
