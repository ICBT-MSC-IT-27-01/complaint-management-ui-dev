  ...
  template: `
    <div class="page-header">
      <div>
        ...
        <p class="page-sub">System performance and compliance metrics for today.</p>
      </div>
      <a routerLink="/complaints/new" class="btn btn-primary btn-new-complaint">
        <i class="bi bi-plus-lg"></i> Create Complaint
      </a>
    </div>
    ...
    <ng-container *ngIf="data() as d">
      <div class="cms-kpi-grid">
        <div class="kpi-card kpi-blue">
          ...
          <div class="kpi-body">
            ...
            <div class="kpi-meta">All tracked cases</div>
          </div>
        </div>
        <div class="kpi-card kpi-green">
          ...
          <div class="kpi-body">
            ...
            <div class="kpi-value">{{ d.slaCompliancePercent }}%</div>
            <div class="kpi-meta">Target: 90%</div>
          </div>
        </div>
        ...
        <div class="kpi-card kpi-orange">
          ...
          <div class="kpi-body">
            ...
            <div class="kpi-value">{{ d.avgResolutionHours || 0 }}h</div>
            <div class="kpi-meta">Resolved today: {{ d.resolvedToday }}</div>
          </div>
        </div>
      </div>
      ...
      <div class="row g-3">
        <div class="col-lg-7">
          <div class="card cms-card chart-surface h-100">
            ...
            <div class="card-body">
              <div *ngFor="let s of d.byStatus" class="status-bar-row mb-2">
                ...
                <div class="progress" style="height: 8px">
                  <div class="progress-bar chart-gridline" [style.width.%]="getStatusPct(s.count, d.totalComplaints)"
        ...
        <div class="col-lg-5">
          <div class="card cms-card chart-surface h-100">
            ...
            <div class="card-body">
              <div *ngFor="let p of d.byPriority" class="d-flex align-items-center py-2 border-bottom">
                <span class="badge" [class]="getPriorityClass(p.priority)">{{ p.priority }}</span>
                <span class="ms-auto fw-semibold">{{ p.count }} issues</span>
              </div>
            </div>
          </div>
        </div>
