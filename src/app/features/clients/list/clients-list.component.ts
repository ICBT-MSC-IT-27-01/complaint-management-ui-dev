              ...
              <tr *ngFor="let c of result()?.items">
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    <a [routerLink]="['/clients', c.id]" class="btn btn-outline-primary" title="View">
                      <i class="bi bi-eye"></i>
                    </a>
                    <a
                    ...
                    <button
                      *ngIf="auth.hasRole('Admin','Supervisor')"
                      ...
                      (click)="remove(c.id)">
                      <span *ngIf="deletingId() === c.id" class="spinner-border spinner-border-sm"></span>
                      <i *ngIf="deletingId() !== c.id" class="bi bi-trash"></i>
                    </button>
                  </div>
                </td>
              </tr>
