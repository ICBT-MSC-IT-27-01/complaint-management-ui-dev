        ...
        <div class="row g-2">
          ...
          <div class="col-lg-3">
            <select class="form-select" [(ngModel)]="req.Role">
              <option value="">All Roles</option><option>Call Center Agent</option><option>Technical Engineer</option><option>Billing Officer</option><option>Supervisor</option><option>Manager</option><option>System Administrator</option><option>Client</option>
            </select>
          </div>
          <div class="col-lg-3">
...
export class UsersListComponent implements OnInit {
  ...
  managerName(role: string): string {
    if (role === 'System Administrator' || role === 'Admin') return 'System';
    if (role === 'Manager') return 'System Administrator';
    if (role === 'Supervisor') return 'Manager';
    if (role === 'Call Center Agent' || role === 'Technical Engineer' || role === 'Billing Officer' || role === 'Agent') return 'Supervisor';
    return 'External';
  }
