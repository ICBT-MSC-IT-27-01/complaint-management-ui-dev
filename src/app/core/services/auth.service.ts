...
export class AuthService {
  ...
  hasRole(...roles: string[]): boolean {
    ...
    const effective = this.expandRoleAliases(user.role);
  ...
  private expandRoleAliases(role: string): string[] {
    const map: Record<string, string[]> = {
      'System Administrator': ['System Administrator', 'Admin'],
      Manager: ['Manager', 'Supervisor'],
      Supervisor: ['Supervisor'],
      'Call Center Agent': ['Call Center Agent', 'Agent'],
      'Technical Engineer': ['Technical Engineer', 'Agent'],
      'Billing Officer': ['Billing Officer', 'Agent'],
      Admin: ['Admin', 'System Administrator'],
      Agent: ['Agent', 'Call Center Agent', 'Technical Engineer', 'Billing Officer'],
      Client: ['Client']
    };
